...
export function ModeToggle() {
  ...
  return (
    <Button variant="outline" onClick={toggleTheme} size="icon">
      <Sun className="h-[1.2rem] dark:hidden w-[1.2rem] scale-100 rotate-0 transition-all dark:scale-0 dark:-rotate-90" />
      <Moon className="dark:block hidden absolute h-[1.2rem] w-[1.2rem] scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0" />
    </Button>
  );
}
